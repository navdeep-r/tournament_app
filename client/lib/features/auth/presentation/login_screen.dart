                                ...
                                children: [
                                  ...
                                  _DummySignInButton(
                                    ...
                                    onTap: isLoading
                                        ...
                                        : () => context
                                            .read<AuthBloc>()
                                            .add(AuthDummySignInRequested('user')),
                                  ),
                                  const SizedBox(height: 16),
                                  _DummySignInButton(
                                    label: 'Login directly as Admin',
                                    ...
                                    onTap: isLoading
                                        ...
                                        : () => context
                                            .read<AuthBloc>()
                                            .add(AuthDummySignInRequested('admin')),
                                  ),
                                ],
                              );
                            },
...
class _DummySignInButton extends StatelessWidget {
  final String label;
  final IconData icon;
  final bool isLoading;
  final VoidCallback? onTap;

  const _DummySignInButton({
    required this.label,
    required this.icon,
